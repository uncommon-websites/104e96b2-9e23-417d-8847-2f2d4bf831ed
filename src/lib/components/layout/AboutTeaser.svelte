...
<script lang="ts">
	...
	name: "Jane Doe",
	role: "CEO, psychologist & co-founder",
	image: "/generated/image-a-female-psychologist-startup-founder-in.webp"
};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"We started Acme so no one has to struggle with focus alone." — Jane Doe, psychologist & co-founder`}
			/>
